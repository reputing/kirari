...
export const THEMES: Record<ThemeId, ThemeDef> = {
  sugar: {
    vars: {
      "--bg": "linear-gradient(165deg,#ffe9f5 0%,#f4edff 46%,#e9f8ff 100%)",
      "--panel": "#fffdfb",
      "--panel-2": "#fff5fb",
      "--ink": "#6e4564",
      "--ink-soft": "#b58aac",
      ...
      "--radius": "18px",
      "--shadow": "0 18px 44px -20px rgba(255,110,180,.45), 0 2px 8px -4px rgba(255,110,180,.2)",
      "--btn-shadow": "0 6px 16px -6px rgba(255,110,180,.5)",
      "--bubble-me": "#ffd6ec",
      ...
      "--titlebar": "linear-gradient(180deg,#ff9ccb,#ff6fb5)",
      "--titlebar-ink": "#ffffff",
      "--rail": "#fff5fb",
      "--tab-active": "#ffe6f3",
      "--deco": "#ff9ed0",
